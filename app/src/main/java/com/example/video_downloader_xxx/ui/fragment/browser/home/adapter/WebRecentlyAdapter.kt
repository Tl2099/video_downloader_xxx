...
class WebRecentlyAdapter: RecyclerView.Adapter<WebRecentlyAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemRecentlyWebBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewHolder = ViewHolder(ItemRecentlyWebBinding.inflate(LayoutInflater.from(parent.context), parent, false))
